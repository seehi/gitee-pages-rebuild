...
class Action:
    def __init__(self):
        ...
        self.username = os.environ['GITEE_USERNAME']
        self.password = os.environ['GITEE_PASSWORD']
        self.repo = os.environ['GITEE_REPO']
        self.branch = os.environ.get('GITEE_BRANCH') or 'master'
        self.directory = os.environ.get('GITEE_DIRECTORY') or ''
        self.https = os.environ.get('GITEE_HTTPS') or True
